import type {
	...
	MigrationResult,
	RenderHintLineLike,
	RenderHintLyricDataLike,
	WordRevealMode
} from './types'

export type { LineRenderHints, LineTimingClass, LineTransitionMode, LineTransitionTiming, WordRevealMode } from './types'
...
export const getLineTransitionTiming = (rawDuration: number, lineTransitionMode: LineTransitionMode, wordRevealMode: WordRevealMode): LineTransitionTiming => {
...
export function buildLineRenderHints(lineOrStart: RenderHintLineLike | number, endTime?: number): LineRenderHints {
	const line = typeof lineOrStart === 'number' ? { startTime: lineOrStart, endTime: endTime ?? lineOrStart } : lineOrStart
...
export function migrateLyricDataRenderHints<T extends RenderHintLyricDataLike>(lyrics: T | null | undefined): MigrationResult<T | null>
export function migrateLyricDataRenderHints<T extends RenderHintLyricDataLike>(lyrics: T | null | undefined): MigrationResult<T | null> {
	if (!lyrics) {
