...
// src/app/music/visualizer/wordColoring.ts
...
const selectNonOverlappingRanges = (ranges: WordColorRange[]): WordColorRange[] => {
	...
	const prioritySorted = [...ranges].sort((a, b) => b.priority - a.priority || a.startOffset - b.startOffset || a.endOffset - b.endOffset)
...
export const prepareWordColorMatchers = (wordColors: Theme['wordColors'], keywordColoringEnabled = true): WordColorMatcher[] => {
...
export const buildWordColorRangesFromMatchers = (lineText: string, matchers: WordColorMatcher[]): WordColorRange[] => {
...
export const buildWordColorRanges = (lineText: string, wordColors: Theme['wordColors'], keywordColoringEnabled = true): WordColorRange[] =>
	buildWordColorRangesFromMatchers(lineText, prepareWordColorMatchers(wordColors, keywordColoringEnabled))
...
export const resolveTokenColorMap = (tokens: WordColorToken[], ranges: WordColorRange[]): Map<string, string> => {
